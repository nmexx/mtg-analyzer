...
export const ARTIFACT_DATA = new Map([
  ...
  [
    'mana crypt',
    { manaAmount: 2, produces: ['C'], entersTapped: false, doesntUntapNaturally: false },
  ],
  [
    'mox diamond',
    {
  ...
  [
    'mana vault',
    { manaAmount: 3, produces: ['C'], entersTapped: false, doesntUntapNaturally: true },
  ],
  [
    'grim monolith',
    { manaAmount: 3, produces: ['C'], entersTapped: false, doesntUntapNaturally: true },
  ...
  [
    'prismatic lens',
    { manaAmount: 1, produces: ['C', 'W', 'U', 'B', 'R', 'G'], entersTapped: false },
  ],
  ...
  [
    'chromatic lantern',
    { manaAmount: 1, produces: ['W', 'U', 'B', 'R', 'G'], entersTapped: false },
  ],
  [
    "commander's sphere",
    { manaAmount: 1, produces: ['W', 'U', 'B', 'R', 'G'], entersTapped: false },
...
export const BURST_MANA_SOURCES = new Set(["lion's eye diamond", 'jeweled lotus', 'lotus petal']);
